...
void afficherFinPartie(char tab[3][3], int numeroTour)
{
    ...
    cout << "Tour numero : " << numeroTour -1<< endl;
    cout << "" << endl;
...
bool verifVictoireLigne(char tab[3][3], char symbole)
{
    if  (
        ...
        (tab[0][1] == symbole && tab[1][1] == symbole && tab[2][1] == symbole)) 
    {
        return true;
    }
    else
...
{
    if  ((tab[0][0] == symbole && tab[1][1] == symbole && tab[2][2] == symbole) || (tab[0][2] == symbole && tab[1][1] == symbole && tab[2][0] == symbole))
    {
        return true;
    }
    else
...
{
    if  (
        (tab[0][0] == symbole && tab[1][0] == symbole && tab[2][0] == symbole) || (tab[0][2] == symbole && tab[1][2] == symbole && tab[2][2] == symbole) ||
        (tab[0][1] == symbole && tab[1][1] == symbole && tab[2][1] == symbole)) 
    {
        return true;
    }
